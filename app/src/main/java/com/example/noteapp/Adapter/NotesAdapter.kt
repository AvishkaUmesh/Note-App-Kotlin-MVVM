...
class NotesAdapter(private val context: Context, val listener: NotesClickListener) :
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        holder.noteLayout.setCardBackgroundColor(context.resources.getColor(RandomColor(), null))
        ...
        holder.noteLayout.setOnLongClickListener {
            listener.onLongItemClicked(NotesList[holder.adapterPosition], holder.noteLayout)
            true
        }
    }
